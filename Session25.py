"""
 Here 2 windows are being made
 1st window is for CRUD operations,i.e. Add,Update,Delete,Fetch; and in 2nd window,
 if we click on Add Customer in run(),it will make a new window in which we can customer's name,phone,email.
...
class CustomerManagementApp:
    ...
    def add_customer_gui(self):
        ...
        lbl_name = Label(add_customer_window, text="Enter Customer Name:")
        lbl_name.pack()
